...
namespace TaiwanWeatherHerald.Services.WeatherService.Models.HourlyForecastInfo
{
    ...
    public class ElementValue
    {
        ...
        [XmlElement(ElementName = "ApparentTemperature")]
        public int? ApparentTemperature { get; set; }

        [XmlElement(ElementName = "ComfortIndex")]
        public int? ComfortIndex { get; set; }

        [XmlElement(ElementName = "ComfortIndexDescription")]
